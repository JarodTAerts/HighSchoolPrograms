...
'*****************************************************************Cls button, clears the painting****************************************
    ...
    if (mouse(1)>650) and (mouse(1)<700) and (mouse(2)>0) and (mouse(2)<60) and (mouse(0)=1) then
    goto start
    l=0
    end if
    
   if (macfunction ("keydown", 55)) and (macfunction ("keydown",8)) then
    l=0
    for john=1 to 1000000:next john
    goto start
    end if
...
1500 if (mouse(2)>70) and (Mouse(1)<760) then
